...
|Airplane following spline line when scroll|`lamina` <br>`ScrollControls`<br>`cameraGroup`|<- environment effect<br><- following curve line on scroll events<br><- following animation|
