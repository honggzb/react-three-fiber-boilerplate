...
export const Experience = () => {
  ...
  useFrame((_state, delta) => {
    ...
    // need using Quaternion because we can't alert
  ...
  return (
    <>
      ...
      <group position={[-5, 1, -10]}>
        <Text color="white" anchorX={"left"} anchorY="center" fontSize={0.52} maxWidth={2.5} font={"/fonts/DMSerifDisplay-Regular.ttf"}>
          Services
        </Text>
        <Text color="white" anchorX={"left"} anchorY="top"position-y={-0.66} fontSize={0.22} maxWidth={2.5} font={"/fonts/Inter-Regular.ttf"}>
          Do you want a drink?{"\n"}
      ...
      {/* LINE */}
      <group position-y={-2}>
        {/* <Line points={linePoints} color={"white"} opacity={0.5} lineWidth={14} /> */}
        <mesh>
